...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
where \(a\) is the point at which the derivative is taken. Choosing \(a \overset{!}{=} 0\) (expanding around the perturbation at zero strength) turns the Taylor series into a Maclaurin series\footnote{The notation \(x \overset{!}{=} y\) means that \(x\) must be equal to \(y\) by definition.}:
\begin{equation}
