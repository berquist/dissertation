...
\begin{figure}[h]
  ...
  \caption{CLS overlaid on the 2D spectrum of \ce{CO2} in \ce{[Im_{4,1}][TFA]}}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[scale=1]{./paper_01/CLS_fit_BMIMTFA.pdf}
  \caption{CLS fitting of \ce{CO2} \(\nu_3\) 2D spectrum from \ce{[Im_{4,1}][TFA]}}
\end{figure}
...
\begin{landscape}
  ...
  \begin{table}
    ...
    \small
    % \resizebox{1\textwidth}{!}{
    \caption{Geometries optimized without allowing charge transfer.}
