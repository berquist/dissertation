...
\onlyifstandalone{\addbibresource{./paper.bib}}
\onlyifstandalone{\addbibresource{../5773968.bib}}
...
\begin{table}
  ...
  \IfStandalone{\input{almo_polarizabilities_projected_def2-SVP}}{\input{paper_04/almo_polarizabilities_projected_def2-SVP}}
\end{table}
...
\begin{table}
  ...
  \IfStandalone{\input{almo_polarizabilities_projected_def2-SVPD}}{\input{paper_04/almo_polarizabilities_projected_def2-SVPD}}
\end{table}
...
\begin{table}
  ...
  \IfStandalone{\input{point_charge_polarizabilities_table}}{\input{paper_04/point_charge_polarizabilities_table}}
\end{table}
...
\begin{table}
  ...
  \IfStandalone{\input{eda_analysis_table}}{\input{paper_04/eda_analysis_table}}
\end{table}
...
\begin{table}
  ...
  \IfStandalone{\input{eda_analysis_percentages_table}}{\input{paper_04/eda_analysis_percentages_table}}
\end{table}
...
\begin{table}
  ...
  \IfStandalone{\input{point_charge_polarizabilities_percentages_table}}{\input{paper_04/point_charge_polarizabilities_percentages_table}}
\end{table}
